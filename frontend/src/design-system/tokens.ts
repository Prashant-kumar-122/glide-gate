...
export const ROLE_COLORS: Record<TeamRole, { bg: string; text: string }> = {
  Advisor: { bg: 'bg-blue-100', text: 'text-blue-800' },
  Client: { bg: 'bg-teal-100', text: 'text-teal-800' },
  ComplianceOfficer: { bg: 'bg-purple-100', text: 'text-purple-800' },
  CCRep: { bg: 'bg-orange-100', text: 'text-orange-800' },
