...
function ViewCell({ data, context }: ICellRendererParams<CaseOut>) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3 py-1 text-[10px] font-medium uppercase tracking-wide text-gray-400 transition-colors hover:bg-primary-subtle hover:text-primary"
    >
