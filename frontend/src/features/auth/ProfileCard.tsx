      ...
      <div className="rounded-xl bg-white shadow-sm">
        <div className="flex items-center gap-4 border-b border-gray-100 p-6">
          ...
          {isClient && !editing && (
            <button
              onClick={startEdit}
              className="ml-auto rounded-lg border border-gray-300 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
              Edit profile
            </button>
          )}
          ...
          {editing ? (
            <>
              ...
              <div className="border-t border-gray-100 pt-4">
                <p className="mb-3 text-sm font-medium text-gray-700">Change password (optional)</p>
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className={['text-sm font-medium text-gray-900', capitalize ? 'capitalize' : ''].join(' ')}>
          {value}
        </p>
      </div>
    </div>
