        ...
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center bg-primary shrink-0">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
              ...
              <rect x="9" y="1" width="6" height="6" fill="white" opacity="0.6" />
              <rect x="1" y="9" width="6" height="6" fill="white" opacity="0.6" />
              <rect x="9" y="9" width="6" height="6" fill="white" opacity="0.3" />
            </svg>
          </div>
          <span className="text-base font-semibold tracking-tight text-white">GlideGate</span>
        </div>
